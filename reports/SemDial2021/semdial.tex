...
\item[$\nwarrow$] previous utterance by the same speaker;
\item[$\swarrow$] previous utterance by the other speaker;
\item[$\nearrow$] next utterance by the same speaker;
\item[$\searrow$] next utterance by the other speaker.
\end{itemize}
...
\item
  \adjustbox{valign=t}{
    \begin{tabulary}{\linewidth}{>{\bf}lJ>{\em}l}
    A: & I am so sorry to keep you on hold. & Apology \\
    B: & <Laughter> No problem. & Downplayer \\
    A: & Are you at work? & YN-Quest. \\
  \end{tabulary}}
\end{lingex}
