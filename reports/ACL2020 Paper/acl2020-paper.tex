...
One of the most obvious things that can be observed is rhetorical questions: supposedly laughter, can be used as a device to cancel seriousness of the question.
...
\end{table}
  ...
  \caption{Confusion matrices for \texttt{BERT-NL} (top) vs \texttt{BERT-L} (bottom); SWDA corpus.}
    \label{fig:swda-cm}
  \end{figure}
