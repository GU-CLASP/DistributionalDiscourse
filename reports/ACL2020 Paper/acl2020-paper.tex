...
On the example, from the Switchboard corpus shown in Table~\ref{table:example} it is evident that the syntactic structure of dialogue is very different from the written text, even if one imagines a script for a movie or a play.
