...
\title{Tickle me BERT: Using laughter to probe pre-trained encoders for dialogue act recoginiton}
...
Importantly, laughter helpes to classify rhetorical questions correctly, this is because in a conversation it can be used as a device to cancel seriousness or sincerity \citep{ginzburg2015understanding,tepperman2006yeah}, in this case, of a question.
...
For a disaggregeated view, see Figure \ref{fig:f1-by-da} in Appendix~\ref{sec:suppl}.
...
Furthermore, function of laughter and its position in relation to laughable can be reflected in the acoustic form of laughter \citep{tian2016we,mazzocconi2019phd}. 
...
It remains an open question how well the text chat domain transfers to transcribed dialogue and what pre-training schemes are best for the dialogue domain.
...
The same may not be true of dialogue, however.
