...
By looking at laughter, which is certainly missing in the stadnard pre-training corpus, we can determine whether the pre-training is used in the representation of dialogue-specific features.
